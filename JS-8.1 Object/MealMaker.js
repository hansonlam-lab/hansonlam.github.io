const menu = {
  ...
  menu.addDishToCourse('appetizers', 'Fries', 4.70);
  
  menu.addDishToCourse('mains', 'Noodles', 11.00);
  menu.addDishToCourse('mains', 'Steak', 8.05);
  menu.addDishToCourse('mains', 'Salmon', 7.99);
